...
export declare const arrayOf: <TInstance extends Object, TExtendOptions extends TInstanceOfOptions>(data: unknown, target: TConstructor<TInstance>, options?: TExtendOptions) => TInfer<TExtendOptions, TInstance>;
export {};
